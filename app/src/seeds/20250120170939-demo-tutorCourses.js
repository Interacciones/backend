...
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.bulkInsert('TutorCourses', [
      ...
      { idTutor: 2, subject: "Calculo I", createdAt: new Date(), updatedAt: new Date() },
      { idTutor: 2, subject: "Calculo II", createdAt: new Date(), updatedAt: new Date() },
      ...
      { idTutor: 8, subject: "Calculo IV", createdAt: new Date(), updatedAt: new Date() },
      { idTutor: 9, subject: "Calculo I", createdAt: new Date(), updatedAt: new Date() },
      { idTutor: 9, subject: "Calculo II", createdAt: new Date(), updatedAt: new Date() },
      ...
      { idTutor: 10, subject: "Calculo V", createdAt: new Date(), updatedAt: new Date() },
