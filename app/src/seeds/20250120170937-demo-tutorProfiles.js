...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert('TutorProfiles', [
      ...
      { userId: 7, description: 'Programming tutor specializing in JavaScript', priceDescription: 'Code with confidence', photo: "https://interac-ciones.s3.amazonaws.com/default.jpg", contactNumber: '+56900000007', isPublished: false, createdAt: new Date(), updatedAt: new Date() },
      ...
      { userId: 10, description: 'Music tutor specializing in piano', priceDescription: 'Learn piano with personalized lessons', photo: "https://interac-ciones.s3.amazonaws.com/default.jpg", contactNumber: '+56900000010', isPublished: false, createdAt: new Date(), updatedAt: new Date() },
    ]);
  },
